  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_URL}?action=register`, {
        ...
        body: JSON.stringify({ email, password, role: 'salon', profile }),
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Регистрация салона</h1>
          <p className="text-gray-600">Создайте профиль массажного салона в экосистеме Док диалог</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input
                id="name"
                placeholder="Массажный салон «Гармония»"
                value={name}
