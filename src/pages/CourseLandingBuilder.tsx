...
export default function CourseLandingBuilder() {
  ...
  const [data, setData] = useState<CourseLandingData>({
    ...
    aboutCourse: '',
    whatYouLearn: ['', '', '', ''],
    programModules: [{ title: '', description: '', duration: '' }],
    author: {
      name: '',
      position: '',
      bio: '',
    ...
    benefits: ['', '', '', ''],
    testimonials: [{ name: '', text: '', rating: 5, photo: '' }],
    gallery: ['', '', '', ''],
    faq: [{ question: '', answer: '' }],
  ...
  const handleSubmit = async () => {
    // TODO: Отправка на модерацию через API
    alert('Лендинг курса отправлен на модерацию!');
