  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Загружаем данные лендинга по userId
        const landingResponse = await fetch(`https://functions.poehali.dev/ea735e68-a4b3-4d19-bb7a-4f720bd82568?userId=${userId}`);
        ...
        console.error('Failed to load public landing', error);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-600 mb-4">{error || 'Лендинг не опубликован или не существует'}</p>
          <a 
