...
export default function RegisterMasseur() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const profile = { full_name: fullName, phone, city };
    ...
    try {
      const response = await fetch(`${API_URL}?action=register`, {
        ...
        body: JSON.stringify({ email, password, role: 'masseur', profile }),
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Регистрация специалиста</h1>
          <p className="text-gray-600">Создайте профиль массажиста в экосистеме Док диалог</p>
        </div>
