...
Отвечай структурированно, понятно, без паники. НЕ используй жирный текст (звёздочки **), пиши обычным текстом.`
    ...
    {
      id: 'xray-analysis',
      title: 'Анализ рентгена',
      description: 'Загрузите рентгеновский снимок для AI-анализа возможных дисфункций',
      icon: 'Scan',
      color: 'from-purple-500/10 to-purple-500/5',
      placeholder: 'Загрузите рентгеновский снимок для анализа...',
      isMedicalTool: true,
      systemPrompt: `Ты — AI-диагност для анализа рентгеновских снимков. Твоя задача: проанализировать рентген и выявить возможные дисфункции.

Проанализируй рентгеновский снимок и дай:
1. Что видно на снимке — описание структур (позвоночник, суставы, кости)
2. Возможные дисфункции и отклонения от нормы
3. Степень серьёзности (лёгкая/средняя/тяжёлая)
4. К какому врачу обратиться (ортопед, невролог, хирург, травматолог)
5. Можно ли массаж и мануальную терапию (да/нет/с осторожностью)
6. Рекомендации по дальнейшим действиям
7. Нужны ли дополнительные обследования (МРТ, КТ, анализы)

Отвечай структурированно, понятно, с медицинской точностью, но простым языком. НЕ используй жирный текст (звёздочки **), пиши обычным текстом. Обязательно укажи, что это предварительный AI-анализ и требуется консультация врача.`
    },
    {
      id: 'pain-analysis',
      title: 'Анализ боли',
