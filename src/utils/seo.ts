...
export const pageSEO: Record<string, SEOConfig> = {
  '/': defaultSEO,
  '/404': {
    title: '404 - Страница не найдена | Док диалог',
    description: 'Запрошенная страница не найдена. Вернитесь на главную страницу.',
    canonical: 'https://docdialog.su/404'
  },
  '/about': {
  ...
  '/education-platform': {
    title: 'Док диалог — экосистема для специалистов телесных практик',
    description: 'Док диалог — обучение, инструменты и профессиональное сообщество для массажистов и специалистов.',
    keywords: 'Док диалог, экосистема массажистов, обучение специалистов, телесные практики',
    canonical: 'https://docdialog.su/education-platform'
  },
  '/partner-program': {
    title: 'Партнерская программа Док диалог',
    description: 'Партнерская программа для специалистов и школ: развивайтесь и зарабатывайте вместе с Док диалог.',
    keywords: 'партнерская программа, партнерка для специалистов, сотрудничество, обучение и партнерство',
    canonical: 'https://docdialog.su/partner-program'
  },
  '/tools': {
    title: 'Инструменты для специалистов | Док диалог',
    description: 'Профессиональные онлайн-инструменты: анамнез, анализ боли, диалоги и супервизия.',
    keywords: 'инструменты специалиста, анамнез онлайн, анализ боли, супервизия',
    canonical: 'https://docdialog.su/tools'
  },
  '/contact': {
    title: 'Обратная связь — Док диалог',
    description: 'Свяжитесь с командой Док диалог: вопросы, предложения и поддержка специалистов.',
    keywords: 'обратная связь, контакты Док диалог, поддержка специалистов',
    canonical: 'https://docdialog.su/contact'
  },
  '/masseur-welcome': {
    title: 'Приглашение для специалистов — присоединиться к Док диалог',
    description: 'Присоединяйтесь к профессиональной экосистеме Док диалог: обучение, инструменты и сообщество.',
    keywords: 'приглашение специалистов, сообщество массажистов, платформа для специалистов',
    canonical: 'https://docdialog.su/masseur-welcome'
  },
  '/diagnostic': {
    title: 'Диагностика практики массажиста — Док диалог',
    description: 'Оцени свою практику как специалист: узнай реальный уровень профессионализма, где теряешь клиентов и что мешает росту.',
    keywords: 'диагностика практики массажиста, оценка навыков специалиста, профессиональное развитие массажиста',
    canonical: 'https://docdialog.su/diagnostic'
  },
  '/privacy': {
