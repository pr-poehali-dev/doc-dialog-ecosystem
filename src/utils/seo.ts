...
export const pageSEO: Record<string, SEOConfig> = {
  ...
  '/advanced-course': {
    title: 'Продвинутый восстановительный массаж — онлайн-курс для массажистов и специалистов по телу',
    description: 'Практический онлайн-курс по восстановительному массажу: мануальные, висцеральные и нейрорегуляторные техники. Диагностика, работа с позвоночником, ВНС и сложными случаями. Автор — остеопат Сергей Водопьянов.',
    keywords: 'восстановительный массаж обучение, продвинутый массаж курс, мануальные техники онлайн, работа с ВНС массаж, остеопатические техники, курс для массажистов, Док Диалог, Сергей Водопьянов',
    canonical: 'https://docdialog.su/advanced-course'
  },
  '/arsenal-course': {
    title: 'Арсенал массажиста — практический онлайн-курс для уверенной работы с клиентами',
    description: 'Онлайн-курс «Арсенал массажиста» — готовые протоколы для работы с болью в спине, шее, голове, лимфатической системой и стрессом. Подходит начинающим и практикующим массажистам.',
    keywords: 'арсенал массажиста курс, массаж обучение онлайн, протоколы массажа, боль в спине массаж, работа с шеей и ВНЧС, лимфодренаж массаж, Док Диалог',
    canonical: 'https://docdialog.su/arsenal-course'
  },
  '/correction-course': {
    title: 'Коррекция фигуры — онлайн-курс по моделированию тела и работе с клиентами',
    description: 'Онлайн-курс по коррекции фигуры: диагностика, техники моделирования тела и стратегии привлечения клиентов. Практика для массажистов и специалистов по телу без медицинского образования.',
    keywords: 'коррекция фигуры обучение, моделирование тела курс, антицеллюлитный массаж обучение, коррекция фигуры онлайн, массаж для фигуры, привлечение клиентов массажисту',
    canonical: 'https://docdialog.su/correction-course'
  },
  '/viscera-course': {
    title: 'Висцеральный массаж с нуля — онлайн-курс по работе с внутренними органами',
    description: 'Обучение висцеральному массажу с нуля: физиология, подвижность органов, базовые техники и принципы диагностики. Курс для массажистов и телесных практиков.',
    keywords: 'висцеральный массаж обучение, висцералка с нуля, работа с внутренними органами массаж, висцеральные техники онлайн, курс для массажистов, Док Диалог',
    canonical: 'https://docdialog.su/viscera-course'
  },
  '/pregnancy-fitness': {
    title: 'Фитнес для беременных 2 триместр — безопасные онлайн-тренировки для будущих мам',
    description: 'Онлайн-программа фитнеса для беременных во 2 триместре: безопасные тренировки, дыхание, укрепление мышц и поддержка тела. Подходит для занятий дома.',
    keywords: 'фитнес для беременных 2 триместр, тренировки для беременных онлайн, упражнения для беременных, безопасный фитнес беременность, занятия дома для будущих мам',
    canonical: 'https://docdialog.su/pregnancy-fitness'
  },
  '/mastermind-moscow': {
    title: 'Мастермайнд для массажистов в Москве — практика и рост профессионального уровня',
    description: 'Офлайн мастермайнд в Москве для массажистов и телесных специалистов. Практическая отработка техник, разбор кейсов, работа с ВНС и восстановительными протоколами. Ведущий — Сергей Водопьянов.',
    keywords: 'мастермайнд для массажистов Москва, офлайн обучение массажу, практика массажа Москва, мастермайнд Док Диалог, Сергей Водопьянов мастермайнд',
    canonical: 'https://docdialog.su/mastermind-moscow'
  },
  '/basics-course': {
    title: 'Первые шаги в массаже — онлайн-курс для начинающих массажистов',
    description: 'Онлайн-курс «Первые шаги в массаже» — базовая подготовка для старта в профессии массажиста. Диагностика, основы работы с телом, понимание клиента и безопасные техники. Подходит для новичков без опыта.',
    keywords: 'первые шаги в массаже, массаж с нуля обучение, курс для начинающих массажистов, основы массажа онлайн, обучение массажу без опыта, Док Диалог',
    canonical: 'https://docdialog.su/basics-course'
  },
  '/vns-course': {
    title: 'Регуляция ВНС — онлайн-курс для массажистов и телесных специалистов',
    description: 'Практический онлайн-курс по регуляции вегетативной нервной системы (ВНС). Влияние ВНС на мышечный тонус, боль, фасции и стресс. Инструменты для глубокой и устойчивой работы с клиентом.',
    keywords: 'регуляция ВНС курс, вегетативная нервная система массаж, работа с ВНС обучение, нейрорегуляция массаж, стресс и нервная система, Док Диалог, Сергей Водопьянов',
    canonical: 'https://docdialog.su/vns-course'
  },
  '/brand-course': {
    title: 'Личный бренд массажиста — онлайн-курс по продвижению и привлечению клиентов',
    description: 'Онлайн-курс по построению личного бренда массажиста и телесного специалиста. Позиционирование, упаковка экспертизы, контент, доверие и стабильный поток клиентов без агрессивных продаж.',
    keywords: 'личный бренд массажиста, маркетинг для массажистов, продвижение массажиста, как привлекать клиентов массажисту, личный бренд специалиста по телу, Док Диалог',
