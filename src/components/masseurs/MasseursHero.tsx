    ...
    <section className="relative py-12 md:py-20 lg:py-28 animate-fade-in overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl text-muted-foreground mb-6 md:mb-10 leading-relaxed animate-fade-in [animation-delay:200ms] px-4 max-w-4xl mx-auto">
            Док диалог — экосистема для специалистов по телу, где вы учитесь у лучших школ, получаете клиентов и растёте в профессии.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center mb-8 md:mb-12 animate-fade-in [animation-delay:300ms]">
            <Button 
              size="lg" 
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-3xl mx-auto animate-fade-in [animation-delay:400ms]">
            {[
