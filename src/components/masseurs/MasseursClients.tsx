        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
            {[
              ...
              <Card 
                key={index} 
                className={`animate-scale-in hover:shadow-xl transition-all duration-300 bg-gradient-to-br ${benefit.color} border-primary/10 sm:col-span-1 ${index === 2 ? 'sm:col-span-2 md:col-span-1' : ''}`}
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl border border-primary/20">
            <div className="text-center max-w-3xl mx-auto">
              <Icon name="Shield" className="text-primary mx-auto mb-4 sm:mb-5" size={40} />
