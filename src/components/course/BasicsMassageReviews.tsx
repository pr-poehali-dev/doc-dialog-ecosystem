        ...
        <div className="relative">
          ...
          >
            {reviews.map((review, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-[280px] sm:w-[320px] md:w-[400px] bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow snap-start border border-gray-100"
              >
