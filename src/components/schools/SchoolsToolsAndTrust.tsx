    ...
    <>
      ...
      <section className="py-10 md:py-16 lg:py-20 bg-gradient-to-b from-background to-primary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto mb-6 md:mb-10">
            {[
      ...
      <section className="py-10 md:py-16 lg:py-20 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto mb-6 md:mb-10">
            {[
