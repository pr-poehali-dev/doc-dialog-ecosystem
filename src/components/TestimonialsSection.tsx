...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    type: "client",
    text: "Искала массажиста после операции на позвоночнике. На платформе нашла специалиста с медобразованием, который понял мой диагноз. Результат превзошёл ожидания — через 2 месяца забыла о болях.",
    avatar: "ЕП"
  },
  {
    id: 5,
