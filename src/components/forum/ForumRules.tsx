...
export default function ForumRules({ open, onOpenChange }: ForumRulesProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] bg-slate-900 border-slate-700 max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-white text-2xl flex items-center gap-2">
            <Icon name="ShieldCheck" size={28} className="text-blue-400" />
            Правила форума DocDialog
          </DialogTitle>
        ...
        <div className="space-y-6 text-slate-300">
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
              <Icon name="Heart" size={20} className="text-blue-400" />
              Основные принципы
            </h3>
