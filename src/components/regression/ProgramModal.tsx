      ...
      >
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          {selectedLevel === 3 && (
            <>
              <div className="text-center pb-6 border-b">
                <h2 className="text-3xl font-bold mb-2">УРОВЕНЬ 3</h2>
                <p className="text-xl text-muted-foreground">«Прогрессия. Создание и выбор линии жизни»</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 p-6 rounded-lg border-2 border-blue-200 dark:border-blue-900">
                <h3 className="text-2xl font-bold mb-4 text-center">ЧТО ТАКОЕ ПРОГРЕССИЯ</h3>
                <p className="text-base mb-4">
                  Прогрессия — это метод работы с бессознательным, в котором человек:
                </p>
                <ul className="space-y-2 text-sm mb-4">
                  <li>• выходит за пределы текущего момента</li>
                  <li>• получает доступ к вероятным вариантам будущего</li>
                  <li>• осознаёт последствия своих выборов</li>
                  <li>• формирует новую линию жизни</li>
                </ul>
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg">
                  <p className="font-semibold text-center">
                    👉 Ключевое отличие от визуализации: прогрессия не создаёт фантазий, а исследует уже существующие вероятности.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 1. ГОТОВНОСТЬ К ПРОГРЕССИИ</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Определить, когда прогрессия уместна.</p>
                </div>
                
                <div className="space-y-3 pl-4">
                  <div>
                    <h4 className="font-semibold mb-1">Урок 1. Когда можно работать с будущим</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Признаки готовности клиента</li>
                      <li>• Ошибки ранней прогрессии</li>
                      <li>• Этика работы с будущим</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 2. Запросы для прогрессии</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Что можно смотреть</li>
                      <li>• Что нельзя</li>
                      <li>• Формирование запроса без иллюзий</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 3. Позиция специалиста</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Не предсказатель</li>
                      <li>• Не мотиватор</li>
                      <li>• Проводник осознанности</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 2. ВХОД В ПРОГРЕССИЮ</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Освоить безопасный и устойчивый вход.</p>
                </div>
                ...
                <div className="space-y-3 pl-4">
                  <div>
                    <h4 className="font-semibold mb-1">Урок 4. Точки входа</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Через ощущение направления</li>
                      <li>• Через образ «я в будущем»</li>
                      <li>• Через выбор между вариантами</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 5. Отличие прогрессии от фантазии</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Телесная устойчивость</li>
                      <li>• Отсутствие эмоционального перегруза</li>
                      <li>• Чёткость восприятия</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 6. Ошибки входа</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Навязывание сценариев</li>
                      <li>• Поспешные выводы</li>
                      <li>• Интерпретация вместо наблюдения</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 3. ПРОСМОТР ЛИНИЙ БУДУЩЕГО</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Научиться работать с вероятностями.</p>
                </div>
                
                <div className="space-y-3 pl-4">
                  <div>
                    <h4 className="font-semibold mb-1">Урок 7. Линии жизни</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Что такое линия</li>
                      <li>• Как они формируются</li>
                      <li>• Точки ветвления</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 8. Сравнение вариантов</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Как проживается каждая линия</li>
                      <li>• Телесный отклик</li>
                      <li>• Смысл и энергия</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 9. Ошибки просмотра</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Выбор «красивой картинки»</li>
                      <li>• Игнор тела</li>
                      <li>• Желание гарантии</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 4. ВЫБОР И ФОРМИРОВАНИЕ ЛИНИИ</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Перевести просмотр в реальный выбор.</p>
                </div>
                
                <div className="space-y-3 pl-4">
                  <div>
                    <h4 className="font-semibold mb-1">Урок 10. Момент выбора</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Когда выбор возможен</li>
                      <li>• Когда нужно остановиться</li>
                      <li>• Работа с сомнением</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 11. Закрепление выбора</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Телесная фиксация</li>
                      <li>• Психологическое согласие</li>
                      <li>• Экологичное принятие ответственности</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 12. Что меняется после выбора</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Реакции</li>
                      <li>• События</li>
                      <li>• Сопротивление старых сценариев</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 5. ИНТЕГРАЦИЯ ПРОГРЕССИИ</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Сделать прогрессию частью жизни.</p>
                </div>
                
                <div className="space-y-3 pl-4">
                  <div>
                    <h4 className="font-semibold mb-1">Урок 13. Возврат в настоящее</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Стабилизация</li>
                      <li>• Контакт с телом</li>
                      <li>• Проверка состояния</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 14. Жизнь после прогрессии</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Как не «ждать будущего»</li>
                      <li>• Как действовать сейчас</li>
                      <li>• Поддержка линии выбора</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-1">Урок 15. Повторная прогрессия</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                      <li>• Когда уместна</li>
                      <li>• Когда вредна</li>
                      <li>• Работа с отклонением от линии</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-xl font-bold mb-2">МОДУЛЬ 6. ПРАКТИКА И СУПЕРВИЗИЯ</h3>
                  <p className="text-muted-foreground"><strong>Цель:</strong> Закрепить навык осознанного сопровождения.</p>
                </div>
                
                <div className="space-y-3 pl-4">
                  <ul className="text-sm text-muted-foreground space-y-1 pl-4">
                    <li>• Прогрессия для себя</li>
                    <li>• Прогрессия для клиента</li>
                    <li>• Разбор ошибок</li>
                    <li>• Коррекция позиции специалиста</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-primary/20 to-primary/10 p-6 rounded-lg text-center">
                ...
                <ul className="text-muted-foreground space-y-1">
                  <li>• Практический кейс</li>
                  <li>• Понимание границ метода</li>
                  <li>• Готовность сопровождать клиентов</li>
                </ul>
              </div>
            </>
          )}
