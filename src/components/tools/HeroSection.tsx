...
export default function HeroSection({ onViewTools, onTryFree }: HeroSectionProps) {
  return (
      ...
      <div className="relative container mx-auto px-4 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <Button size="lg" onClick={onViewTools} className="text-lg px-10 py-6 bg-white text-blue-600 hover:bg-blue-50 shadow-xl">
              <Icon name="Search" className="mr-2" size={22} />
              Смотреть инструменты
            </Button>
            <Button size="lg" variant="outline" onClick={onTryFree} className="text-lg px-10 py-6 bg-blue-600 text-white border-2 border-white hover:bg-blue-700 shadow-xl">
